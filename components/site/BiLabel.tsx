...
export default function BiLabel({
  ...
  return (
    <span className={`flex flex-col gap-1 ${className}`}>
      <span className="text-[1rem]/[1.4] font-normal whitespace-nowrap text-text-50">
        {latin}
      </span>
      <span
        lang="ja"
        className="font-ja text-[0.8125rem]/[1.4] font-normal tracking-[0.14em] whitespace-nowrap text-text-38"
      >
        {ja}
      </span>
    </span>
